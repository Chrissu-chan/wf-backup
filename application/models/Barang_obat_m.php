...
class Barang_obat_m extends Barang_m {
    ...
    public function view_barang() {
        $this->db->select('barang.*, satuan.satuan, satuan.grup, obat.id AS id_obat, obat.id_jenis_obat, obat.kandungan_obat, obat.dosis, obat.hpp, obat.diskon_persen, obat.hna, obat.ppn_persen, obat.total')
