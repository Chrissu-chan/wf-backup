...
class Penjualan extends BaseController
{
	...
	public function index()
	{
		...
		$jenis_penjualan = $this->input->get('jenis_penjualan');
		if ($jenis_penjualan == "umum") {
			$this->load->view('transaksi/penjualan/index', array('jenis_penjualan' => $jenis_penjualan, 'title' => $title));
		} else {
			$this->load->view('transaksi/penjualan/index', array('jenis_penjualan' => $jenis_penjualan, 'judul' => $judul));
		}
	}
	...
	public function create()
	{
		...
		if ($jenis_penjualan == 'cabang') {
			$this->load->view('transaksi/penjualan_cabang/create', array(
				'jenis_penjualan' => $jenis_penjualan, 'title' => $title
			));
		} else {
	...
	public function edit($id)
	{
		...
		if ($model->jenis_penjualan == 'umum') {
			...
			$this->load->view('transaksi/penjualan_cabang/edit', array(
				'model' => $model,
				'jenis_penjualan' => $model->jenis_penjualan ,'title'=>$title
			));
		}
	}
