        ...
        public function store() {
            ...
            if ($stock_opname) {
                ...
                if ($stock_opname_detail) {
                	$barang_stok = $this->barang_stok_m->where('id_gudang', $stock_opname->id_gudang)
		                ->where('id_barang', $stock_opname_detail->id_barang)
		                ->first();
                	if ($barang_stok) {
		                ...
		                $record = array(
			                ...
			                'selisih' => $post['jumlah'] - $barang_stok->jumlah,
