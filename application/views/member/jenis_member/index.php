...
<script>
    ...
    $(function() {
        dataTable = $('#data-table').DataTable({
            ...
            columns: [
                {data: 'jenis_member', name: 'jenis_member.jenis_member'},
                {data: 'biaya', name: 'jenis_member.biaya', class: 'text-right'},
                {data: 'ppn_persen', name: 'jenis_member.ppn_persen', class: 'text-center'},
                {data: 'total', name: 'jenis_member.total', class: 'text-right'},
