...
<head>
    <meta charset="utf-8" />
    <title>HaltC - Starter Pack</title>
    <meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport" />
    <meta content="" name="description" />
    <meta content="" name="author" />
    <link rel="icon" href="<?= base_url('public/images/fav.png') ?>" type="image/x-icon"/>
...
<body style="background: url('<?= base_url('public/images/haltec.png') ?>') center no-repeat;">
