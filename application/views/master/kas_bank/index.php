...
<script>
    ...
    $(function() {
        dataTable = $('#data-table').DataTable({
            ...
            columns: [
                {data: 'nama', name: 'kas_bank.nama'},
                {data: 'jenis_kas_bank', name: 'kas_bank.jenis_kas_bank'},
                {data: 'cabang', name: 'cabang.nama'},
                {data: 'bank', name: 'kas_bank.id_bank'},
                {data: 'nomor_rekening', name: 'kas_bank.nomor_rekening'},
                {data: 'nama_rekening', name: 'kas_bank.nama_rekening'},
