...
<script>
    ...
    $(function() {
        dataTable = $('#data-table').DataTable({
            ...
            columns: [
                {data: 'tanggal', name: 'pembelian.tanggal'},
                {data: 'no_pembelian', name: 'pembelian.no_pembelian'},
                {data: 'supplier', name: 'supplier.nama'},
                {data: 'jatuh_tempo', name: 'pembelian.jatuh_tempo'},
                {data: 'kas_bank', name: 'kas_bank.nama'},
                {data: 'total', name: 'pembelian.total', class: 'text-right'},
                {data: 'batal', name: 'pembelian.batal', class: 'text-center'},
